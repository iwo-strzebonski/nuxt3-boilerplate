...
/**
 * @vue/test-utils v2.2.5
 * (c) 2022 Lachlan Miller
 * Released under the MIT License
 */

import * as Vue from 'vue';
import { nextTick, setDevtoolsHook, Teleport, KeepAlive, Transition, BaseTransition, TransitionGroup, defineComponent, h, shallowReactive, reactive, isRef, ref, createApp, transformVNodeArgs, computed } from 'vue';
...
function createStubComponentsTransformer(_a) {
    ...
    return function componentsTransformer(type, instance) {
        ...
        if (type === KeepAlive && 'keep-alive' in stubs) {
            if (stubs['keep-alive'] === false)
                return type;
            return createStub({
                name: 'keep-alive',
                type: type,
