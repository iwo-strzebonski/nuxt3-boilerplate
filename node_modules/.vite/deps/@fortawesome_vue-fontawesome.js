...
__reExport(fontawesome_svg_core_exports, fontawesome_svg_core_star);
import * as fontawesome_svg_core_star from "@fortawesome/fontawesome-svg-core";
...
function normalizeIconArgs(icon2) {
  ...
  if (fontawesome_svg_core_exports.parse.icon) {
    return fontawesome_svg_core_exports.parse.icon(icon2);
  }
  if (icon2 === null) {
    return null;
  }
...
var FontAwesomeIcon = defineComponent({
  ...
  setup: function setup(props, _ref) {
    ...
    var transform = computed(function() {
      return objectWithKey("transform", typeof props.transform === "string" ? fontawesome_svg_core_exports.parse.transform(props.transform) : props.transform);
    });
    var mask = computed(function() {
      return objectWithKey("mask", normalizeIconArgs(props.mask));
    });
    var renderedIcon = computed(function() {
      return (0, fontawesome_svg_core_exports.icon)(icon$1.value, _objectSpread2(_objectSpread2(_objectSpread2(_objectSpread2({}, classes.value), transform.value), mask.value), {}, {
        symbol: props.symbol,
        title: props.title
      }));
    });
...
var FontAwesomeLayers = defineComponent({
  ...
  setup: function setup2(props, _ref) {
    ...
    var familyPrefix = fontawesome_svg_core_exports.config.familyPrefix;
...
var FontAwesomeLayersText = defineComponent({
  ...
  setup: function setup3(props, _ref) {
    ...
    var abstractElement = computed(function() {
      var _text = (0, fontawesome_svg_core_exports.text)(props.value.toString(), _objectSpread2(_objectSpread2({}, transform.value), classes.value)), abstract = _text.abstract;
      if (props.counter) {
